...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _getPlanetImg(int index, String name){
    if (name == 'Tatooine') {
      return Image.network('https://static.wikia.nocookie.net/esstarwars/images/b/b0/Tatooine_TPM.png/revision/latest?cb=20131214162357');
    } else {
      return Image.network('https://starwars-visualguide.com/assets/img/planets/'+(index+1).toString()+'.jpg', width: 100);
    }
  }
